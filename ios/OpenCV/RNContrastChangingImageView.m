...
//  url = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:imgUrl]]];
//}
//
...
//  
//  CIImage* editedImage = nil;
//  UIImage* new_imageUI = [self UIImageFromCVMat:matImage];
//  [new_imageUI CIImage: editedImage];
//  mImgUI = [mImgUI imageWithCIImage: editedImage];
//}
//
